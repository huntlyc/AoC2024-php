<?php
        ...
        public function getShortestPathBetween(Position $start, Position $end): int{
            ...
            foreach($this->queue as ["data" => $pathPoint, "priority" => $priority]){
                ...
                if($pathPoint->position == $end){
                    /**
                     * We go until we've gone past our short path
                     **/
                    ...
                    // mark grid with current path points for seating calc
                    foreach($path as $p){
                        $this->grid->setCell($p, 'O');
                    }
                }
            ...
            return 0; // we will hit here eventually
    ...
    function main():void{
        ...
        $pathFinder->getShortestPathBetween($start, $end);
