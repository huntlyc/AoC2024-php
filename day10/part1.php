...
class PathFinder{
    ...
    public function solve(): int{
        ...
        foreach($this->startingPositions as $startingPosition){
            ...
            if(!empty($this->endingPositions)){
                ...
                foreach($this->endingPositions as $origin => $endingPositions){
     ...
     * @return int
     */
    private function findPathFromPoint(Point $origin, Point $startingPosition, int $ans = 0): bool{
        ...
        if($this->grid->getGrid()[$startingPosition->y][$startingPosition->x] === '9'){
            ...
            if(!isset($currentEndPointsFromOrigin)){
